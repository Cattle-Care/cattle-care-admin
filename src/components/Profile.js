...
function Profile() {
	...
	<div class="text-center text-gray-300 px-3 pb-6 pt-2">
		<h3 class=" text-sm bold font-sans">hjsahhsadh</h3>
		<p class="mt-2 font-sans font-light text-grey-dark">dhgfhdgfhdgfhdgf</p>
	</div>
