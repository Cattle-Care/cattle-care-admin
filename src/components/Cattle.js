...
<div className="flex justify-end items-center   h-20">
      ...
      >
        Add Cattle<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
              ...
              <div className="border-0 left-16 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="relative p-6 flex-auto ">
                  ...
                  <input type="text" id="email " name="email" className="w-full p-2 bg-transparent focus:border-blue-900 hover:border-green-400 px-8 border-b-2 text-black border-blue-700  outline-none "/>
                  </div>
                  <div className="my-4 text-lg leading-relaxed">
                  <input type="text" id="email " name="email" className="w-full p-2 bg-transparent focus:border-blue-900 hover:border-green-400 px-8 border-b-2 text-black border-blue-700   outline-none "/>
                  </div>
